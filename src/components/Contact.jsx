          ...
          >
            <div>
              ...
              <p className="text-muted-foreground">
                ...
                We'd love to hear from you. Reach out through the form or contact 
                us directly.
              </p>
            </div>
            ...
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <a href="mailto:hello@rivnext.com" className="text-muted-foreground hover:text-primary transition-colors">
                    hello@rivnext.com
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">
                    Available Worldwide<br />Remote-First Company
                  </p>
                </div>
              </div>
            </div>
